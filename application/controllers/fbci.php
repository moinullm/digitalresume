...
class Fbci extends CI_Controller {
   ...
   public function __construct(){
	...
	function logout(){
		...
		header('Location: '.$base_url.'index.php/fbci/index');  //redirect to the home page
	}
	...
	function fblogin(){
		...
		if($user){
			...
			try{
				...
				$params = array('next' => $base_url.'index.php/fbci/logout');
				...
				header('Location: '.$base_url.'index.php/fbci/index');
